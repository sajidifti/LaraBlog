...
<section class="w-full md:w-2/3 flex flex-col items-center px-3">
    ...
    <article class="flex flex-col shadow my-4">
        ...
        <div class="bg-white flex flex-col justify-start p-6">
            ...
            <a href="#" id="post-title-link" class="text-3xl font-bold hover:text-gray-700 pb-4">{{ $post->title }}</a>
    ...
    <div class="w-full flex pt-6">
        ...
        @else
            <div class="w-1/2 bg-white shadow text-right p-6 opacity-50">
                <p class="text-lg text-gray-400 flex items-center justify-end">Next <i class="fas fa-arrow-right pl-1"></i>
                </p>
