@persist('postModal')
                ...
                <form class="relative p-4 min-[0px]:overflow-y-auto" id="postForm" method="POST"
                    ...
                    <div class="relative p-4 min-[0px]:overflow-y-auto">
                        ...
                        <div class="mb-5">
                            ...
                            <div id="post-file-input-container">
                            ...
                            <button type="button" id="post-add-file-input"
                                class="w-full bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-4">
                                Add More Files
                            </button>
                            <div class="mt-1 text-sm text-gray-500 dark:text-gray-300">Upload
                                Images
    ...
    <script>
        document.getElementById('post-add-file-input').addEventListener('click', function() {
        ...
        `;
            ...
            document.getElementById('post-file-input-container').appendChild(newFileInput);
        });
    </script>
